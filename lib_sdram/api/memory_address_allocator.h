...
/* \fn void memory_address_allocator(unsigned client_count, server interface memory_address_allocator_i rx[client_count], unsigned base_address, unsigned memory_size);
 * \brief The distributable server for providing memory address to multiple clients.
 *
